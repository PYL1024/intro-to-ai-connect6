...
> 摘要：汇总当前版本在 g06 包内的核心数据结构、方法与用途，便于后续迭代（α-β 剪枝、增量评估等）。
...
- 常量：`BOARD_SIZE=19`、`AI_NAME="G06-V2-AlphaBetaAI"`、`USE_ALPHA_BETA=true`
...
- ShuffleUtil 等在 util 包，当前未被 g06 主要流程调用。
